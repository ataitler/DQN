...
W5 = tf.Variable(tf.random_uniform([neu4, neu5], -1./neu4, 1./neu4))
b5 = tf.Variable(tf.random_uniform([neu5], -1./neu4, 1./neu4))
z5 = tf.nn.relu(tf.matmul(z4, W5)+b5)

W6 = tf.Variable(tf.random_uniform([neu5, 10], -1./neu5, 1./neu5))
b6 = tf.Variable(tf.random_uniform([10], -1./neu5, 1./neu5))
#z5 = tf.nn.relu(tf.matmul(z4, W5)+b5)
